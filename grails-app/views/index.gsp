...
<html>
  <head>
    <title>Welcome to Grails - haml</title>
  ...
  <body>
    <div id='nav'>
      <div class='homePagePanel'>
        ...
        <div class='panelBody'>
          ...
          <ul>
            <g:set value="${applicationContext.getBean('pluginManager')}" var='pluginManager'></g:set>
            <g:each in='${pluginManager.allPlugins}' var='plugin'>
    ...
    <div id='pageBody'>
      ...
      <div class='dialog' id='controllerList'>
